...
export default function FullScreenMenu({ onClose }: FullScreenMenuProps) {
    ...
    return (
        ...
        >
            ...
            <div className="sticky top-0 z-10 bg-[#002FA7] flex justify-between items-center w-full px-6 md:px-12 py-5 border-b border-white/10">
            ...
            {/* Footer / Socials */}
            <div className="px-6 md:px-12 pb-12 flex justify-between items-end border-t border-white/20 pt-8">
